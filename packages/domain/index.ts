...
export { DataSourceConnection, User, Role, GenericEntity, Student, Activity, ActivityStudent, CourseClass, Course, SessionClass, ClassStudent, Attendance, Session, Department };